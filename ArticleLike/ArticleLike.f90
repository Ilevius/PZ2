    ...
    CONTAINS 
        ...
        complex*16 gammas(2), G(2), delta1_c, test
            ...
            delta1 = real(delta1_c)+imag(delta1_c)
        END FUNCTION delta1    
        ...
        complex*16 gammas(2), G(2), delta2_c, test
            ...
            delta2 = real(delta2_c)+imag(delta2_c)
        END FUNCTION delta2  
        ...
        implicit none
        real*8 alfa, d
        complex*16 gammas(2), G(2), delta1Halfc, test
            d = h/2d0
            gammas = MakeGamma(alfa)
            G = MakeG(alfa)
        ...
        complex*16 gammas(2)
            ...
            do fCurrent = fmin, fmax, fstep
                ...
                !call Halfc(delta1Halfc, 1d-6, 25d0, 1d-3, 1d-4, 4, dz, Ndz)
                call Hamin(delta1,       1d-6, 300d0, 1d-3, 1d-3, 10, dz, Ndz)
                do i = 1, Ndz
                    write(1, '(3E15.6E3)') fCurrent*h, dz(i), wCurrent/dz(i)
                enddo
                
                call Hamin(delta2,       1d-6, 300d0, 1d-4, 1d-3, 10, dz, Ndz)
                do i = 1, Ndz
                    write(1, '(3E15.6E3)') fCurrent*h, dz(i), wCurrent/dz(i)
                enddo
